...
Patch1: backport-rt-146661-apostrophe.patch
...
cp %{_builddir}/CSS-DOM-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-CSS-DOM/a94d9d601f2c9ddcdd8f8e308e6688096f8dc0ee || :
if test -f Makefile.PL; then
